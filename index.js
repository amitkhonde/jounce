...
module.exports = {
    ...
    animate: () => {
        ...
        insertStyleSheetRule(`#jounceMainDiv{animation-name: move-right; animation-duration: 3s;}`, 2);
        insertStyleSheetRule(`#jounceSubDiv{animation-name: move-top; animation-duration: 3s;}`, 3);
